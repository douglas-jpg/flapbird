...
IMG_CHAO = pygame.transform.scale2x(
    pygame.image.load(os.path.join('imagens', 'base.png')))
IMG_FUNDO = pygame.transform.scale2x(
    pygame.image.load(os.path.join('imagens', 'bg.png')))
IMG_CANO = pygame.transform.scale2x(
...
class Passaro:
    ...
    def desenhar(self, tela):
        ...
        # se o passaro tiver caindo não bate asas
        if self.angulo <= -80:
            self.imagem = self.IMGS[1]
...
def desenhar_tela(tela, passaros, canos, chao, pontos):
    ...
    tela.blit(texto, (TELA_X - 10 - texto.get_width(), 10))
    chao.desenhar(tela)
...
def main():
    ...
    while rodando:
        ...
        # a pessoa apertando a tecla de espaço
